...
<html lang="en">
    ...
    <body class="animated bounceInDown">
        ...
        <div class="content">
            <h1 class="title">Seanse filmowe<br>Kapitan Ameryka:<br>wojna bohaterów</h1>
            <br><br>
...
$query = 'SELECT S.ID_seans, F.tytul, SA.ilosc_miejsc, SA.ID_sala, S.dzien_tygodnia, S.godzina FROM Seans S, Film F, Sala SA WHERE S.ID_film = F.ID_film AND F.ID_film = 1
 AND SA.ID_sala = S.ID_sala ORDER BY ID_seans;';
...
?>
 ...
 <font color="red">Uwaga!</font> Jeśli zdecydowałeś się na któryś z seansów, zapamiętaj jego numer ID (<i>ID seansu</i>). Jest to niezbędne do rezerwacji biletów.
		 ...
		 <br> <br>		 
<input type="button" onclick="location.href='Kapitan_Ameryka_wojna_bohaterów.html';" value="Powrót do opisu filmu" />
               <br> <br>    
