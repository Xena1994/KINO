...
<html lang="en">
    ...
    <body class="animated bounceInDown">
        ...
        <div class="content">
            <h1 class="title">Seanse filmowe<br>High-Rise</h1>
            <br><br>
...
WHERE S.ID_film = F.ID_film AND F.ID_film = 12 AND SA.ID_sala = S.ID_sala ORDER BY ID_seans;';
...
?>
 ...
 <font color="red">Uwaga!</font> Jeśli zdecydowałeś się na któryś z seansów, zapamiętaj jego numer ID (<i>ID seansu</i>). Jest to niezbędne do rezerwacji biletów.
		 ...
		 <br> <br>		 
<input type="button" onclick="location.href='High_Rise.html';" value="Powrót do opisu filmu" />
               <br> <br>    
